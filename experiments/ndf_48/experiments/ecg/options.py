...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--ngf', type=int, default=48)
        self.parser.add_argument('--ngfs', type=int, default=48)
        self.parser.add_argument('--ndf', type=int, default=48)
        self.parser.add_argument('--ndfs', type=int, default=48)

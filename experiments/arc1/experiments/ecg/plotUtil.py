...
def loss_plot(hist, path = 'Train_hist.png', model_name = ''):
    ...
    ax1.plot(x, y1,'r',label="D_loss_s")
    ax1.set_ylabel('D_loss')

    # ax2 = ax1.twinx()  # this is the important function
    # ax2.plot(x, y2, 'b',label="D_loss_f")

    ax3 = ax1.twinx()  # this is the important function
    ax3.plot(x, y3, 'g',label="G_loss_s")

    ax4 = ax1.twinx()  # this is the important function
    ax4.plot(x, y4, 'c',label="G_loss_f")
...
def auc_plot(hist, path = 'Train_hist.png', model_name = ''):
    ...
    ax1=fig.add_subplot(111)
    ax1.plot(x, y1,'r',label="AUC_S")

    # ax2 = ax1.twinx()  # this is the important function
    # ax2.plot(x, y2, 'b',label="AUC_F")
...
def test_auc_plot(hist, path = 'Test_hist.png', model_name = ''):
    ...
    path = os.path.join(path, model_name + '_test_auc.png')

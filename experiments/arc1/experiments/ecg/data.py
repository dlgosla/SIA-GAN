...
def load_data(opt):
    ...
    if opt.dataset=="ecg":
        ...
        #- freq
        N_samples_f = np.load(os.path.join(opt.dataroot1,'n_spectrogram.npy'))
        S_samples_f = np.load(os.path.join(opt.dataroot1,'s_spectrogram.npy'))
        V_samples_f = np.load(os.path.join(opt.dataroot1,'v_spectrogram.npy'))
        F_samples_f = np.load(os.path.join(opt.dataroot1,'f_spectrogram.npy'))
        Q_samples_f = np.load(os.path.join(opt.dataroot1,'q_spectrogram.npy'))

...
class Generator(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.freq_2d_encoder = Signal_Encoder(opt.ngpu,opt,opt.nz)
    ...
    def forward(self, x_sig, x_freq):
        ...
        latent_freq = self.linear_f(x_freq) #[bs,50,128]

        x_fusion = torch.cat([x_sig, x_freq], dim=1) #[bs,100,1]
...
class BeatGAN(AD_MODEL):
    ...
    def __init__(self, opt, dataloader, device):
        ...
        pretrained_freq_encoder = os.path.join(save_dir, 'beatgan_tf_encoder.pkl')
    ...
    def update_netd(self):
        ...
        self.fake_s, self.fake_f = self.G(self.input_s, self.input_s)

...
from network import Generator_Transformer,Encoder,Decoder,AD_MODEL,weights_init,print_network
...
class Generator(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.tf = Generator_Transformer(ninp=128, nhead=8, nhid=512, dropout=0.0, nlayers=3)
...
class BeatGAN(AD_MODEL):
    ...
    def __init__(self, opt, dataloader, device):
        ...
        self.bcelogit_criterion = nn.BCEWithLogitsLoss()
